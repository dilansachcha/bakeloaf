...
<head>
    ...
    <title>Cakes & Cupcakes | BakeLoaf</title>
    ...
    <div class="col-12 container-fluid  d-flex justify-content-center align-items-center ">
        <div class="row d-flex justify-content-center  ">
            ...
            <div class="col-12 d-flex justify-content-start row">
                <span class="text-dark fw-bold">Indian Food</span>
            ...
            <div class="col-12">
                <div class="row justify-content-center gap-5">
                    ...
                    $food_rs = Database::search("SELECT * FROM `foods` INNER JOIN `food_images` ON foods.id = food_images.food_id WHERE `category_id`= '2' ");
                    $ft = $food_rs->num_rows;
