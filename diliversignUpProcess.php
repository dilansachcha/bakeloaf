...
if (empty($fname)) {
    ...
    $rs = Database::search("SELECT * FROM `diliverer` WHERE `email` = '" . $email . "' OR `mobile` = '" . $mobile . "'");
    $n = $rs->num_rows;
    ...
    if ($n > 0) {
        ...
        Database::iud("INSERT INTO `diliverer` (`fname`,`lname`,`email`,`mobile`,`password`,`gender_id`,`joined_date`,`deliverer_status_id`)
