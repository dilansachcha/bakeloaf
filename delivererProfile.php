...
<head>
    ...
    <title>User Profile | easyfoods</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["d"])) {
                ...
                $detail_rs = Database::search("SELECT * FROM `diliverer` INNER JOIN `gender` ON
                gender.id = diliverer.gender_id WHERE `email` = '" . $email . "'");

                $image_rs = Database::search("SELECT * FROM `deliverer_profile_images` WHERE `deliverer_email` = '" . $email . "'");

                $address_rs = Database::search("SELECT * FROM `deliverer_has_address` INNER JOIN `city` ON
                deliverer_has_address.city_id = city.id INNER JOIN `district` ON
                city.district_id = district.id INNER JOIN `province` ON
                district.province_id = province.id WHERE `deliverer_email` = '" . $email . "'");
                        ...
                        <div class="col-12 bg-body rounded">
                            <div class="row g-2">
                                ...
                                <div class="col-md-12 d-flex justify-content-center ">
                                    <div class="col-4 shadow-lg rounded-5  d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        <label for="profileimg" class="btn btn-outline-success mt-5" onclick="changeImage1();">Update Profile Image</label>
                                        ...
                                        <div class="row  g-3">
                                            ...
                                            <div class="col-12  d-flex justify-content-center mt-5">
                                                ...
                                                <div class="col-4 d-grid">
                                                    <button class="btn btn-success shadow-lg" onclick="updateProfile1();">Update My Profile</button>
                                                </div>
